...
export const COMPONENTS: readonly ComponentDef[] = [
  ...
  { id: "roof.underlayment", label: "underlayment", trade: "roofing", lexemes: ["underlayment", "roofing felt", "tar paper", "ice and water shield", "ice and water barrier", "synthetic underlayment", "underlay", "felt", "ice and water membrane"], defaultUnit: "square" },
  ...
  { id: "roof.pipe_boot", label: "pipe boots", trade: "roofing", lexemes: ["pipe boot", "vent boot", "plumbing boot", "pipe flashing", "vent flashing", "pipe jack", "stack flashing", "plumbing stack"], defaultUnit: "each" },
  ...
  { id: "roof.downspout", label: "downspouts", trade: "roofing", lexemes: ["downspout", "down spout", "leader", "downpipe"], defaultUnit: "each" },
  ...
  { id: "roof.tearoff", label: "tear-off", trade: "roofing", lexemes: ["tear off", "tear-off", "tearoff", "strip the roof", "remove existing shingle", "remove the existing roof", "strip existing"], defaultUnit: "square", ancillary: true },
  { id: "roof.attic_ventilation", label: "attic ventilation", trade: "roofing", lexemes: ["attic ventilation", "attic fan", "roof vent", "turbine vent", "box vent"], defaultUnit: "each" },

  // ── plumbing ───────────────────────────────────────────────────────────────
  { id: "plumb.water_heater", label: "water heater", trade: "plumbing", lexemes: ["water heater", "hot water heater", "water tank", "hot water tank", "hot water system", "hot water unit"], defaultUnit: "each" },
  ...
  { id: "plumb.main_shutoff", label: "main shutoff valve", trade: "plumbing", lexemes: ["main shutoff", "main shut off", "main shut-off", "main valve", "shutoff valve", "stop valve", "angle stop", "valve", "shutoff"], defaultUnit: "each" },
  { id: "plumb.supply_line", label: "supply line", trade: "plumbing", lexemes: ["supply line", "water line", "water supply", "riser", "supply stub"], defaultUnit: "linear_ft" },
  ...
  { id: "plumb.sewer_line", label: "sewer line", trade: "plumbing", lexemes: ["sewer line", "sewer lateral", "main sewer", "sewer main", "main line", "clay pipe", "city tap"], defaultUnit: "linear_ft", concealed: true },
  ...
  // ── electrical ─────────────────────────────────────────────────────────────
  { id: "elec.panel", label: "electrical panel", trade: "electrical", lexemes: ["electrical panel", "breaker panel", "load center", "load centre", "service panel", "panel", "consumer unit", "switchboard", "fuse box"], defaultUnit: "each" },
  { id: "elec.service_upgrade", label: "service upgrade", trade: "electrical", lexemes: ["service upgrade", "amp service", "service entrance", "upgrade the service", "upgrade service"], includes: ["elec.panel", "elec.meter_base", "elec.grounding", "elec.breaker"], defaultUnit: "lot" },
  ...
  { id: "elec.outlet", label: "outlets", trade: "electrical", lexemes: ["outlet", "receptacle", "wall socket", "power point", "socket", "double socket"], defaultUnit: "each" },
  { id: "elec.switch", label: "switches", trade: "electrical", lexemes: ["light switch", "dimmer", "three way switch", "switch"], defaultUnit: "each" },
  { id: "elec.wiring", label: "wiring", trade: "electrical", lexemes: ["wiring", "rewire", "rewiring", "romex", "new circuit", "circuit run", "run a circuit", "nm b"], defaultUnit: "linear_ft", concealed: true },
  ...
  { id: "elec.fixture", label: "light fixtures", trade: "electrical", lexemes: ["light fixture", "recessed light", "can light", "fixture", "sconce", "shop light"], defaultUnit: "each" },
  ...
  { id: "elec.ev_charger", label: "EV charger", trade: "electrical", lexemes: ["ev charger", "car charger", "level 2 charger", "evse", "wall connector"], defaultUnit: "each" },
  ...
  { id: "hvac.thermostat", label: "thermostat", trade: "hvac", lexemes: ["thermostat", "smart thermostat", "t stat", "tstat"], defaultUnit: "each" },
  { id: "hvac.ductwork", label: "ductwork", trade: "hvac", lexemes: ["ductwork", "duct work", "duct", "supply plenum", "return plenum", "plenum", "sheet metal transition"], defaultUnit: "linear_ft", concealed: true },
  ...
  { id: "hvac.condensate", label: "condensate drain", trade: "hvac", lexemes: ["condensate", "drain pan", "condensate pump", "secondary pan", "drain", "float switch"], defaultUnit: "each" },
  ...
  { id: "gen.mold_remediation", label: "mould remediation", trade: "general", lexemes: ["mold", "mould", "remediation", "microbial", "antimicrobial", "hepa", "negative air", "containment", "encapsulant"], defaultUnit: "sq_ft", concealed: true },
  { id: "gen.water_damage", label: "water damage mitigation", trade: "general", lexemes: ["water damage", "water mitigation", "dry out", "dryout", "dehumidifier", "drying equipment", "water extraction", "extraction"], defaultUnit: "lot", concealed: true },
  { id: "gen.flooring", label: "flooring", trade: "general", lexemes: ["flooring", "subfloor", "sub floor", "underlay", "laminate", "hardwood floor", "carpet", "floor tile"], defaultUnit: "sq_ft" },
  ...
  { id: "gen.disposal", label: "debris disposal", trade: "general", lexemes: ["dumpster", "debris removal", "haul away", "disposal fee", "disposal", "landfill", "dispose", "haul off"], defaultUnit: "lot", ancillary: true },
  ...
  { id: "gen.inspection", label: "inspection", trade: "general", lexemes: ["inspection", "assessment", "evaluation", "evaluate", "diagnostic", "site visit", "second opinion", "clearance test"], defaultUnit: "lot" },
